...
if any(file_has_content(filename) for filename in output_files):
 clear_all_files_response = input("Wanna Clear Cache? (y/n): ")
...
print(Fore.WHITE + " ")
reply = input('Do You Wanna Delete Duplicated Gift Links? (y/n): ')
...
print(Fore.WHITE + " ")
respond_to_validcodes = input("Hide Working links? (suggested if u are making a video) (y/n): ")
